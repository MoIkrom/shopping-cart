...
@method('PUT')
    ...
    <div class="my-3 mt-5 p-5 bg-body rounded shadow-sm">
        ...
        <div class="p-5">
            <div class="mb-3 row">
                <label for="productname" class="col-sm-2 col-form-label">ID Product</label>
                <div class="col-sm-10">
                    <input type="text" disabled class="form-control" name='id' id="id" value="{{$data->id}}">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='productcode' id="productcode" value="{{$data->productcode}}">
                </div>
            </div>
            <div class="mb-3 row">
        ...
        <div class="d-flex justify-content-center mb-3 ">
            ...
            <div class="d-flex justify-content-between col-sm-10"><button type="submit" class="btn btn-primary" name="submit">SIMPAN</button>
